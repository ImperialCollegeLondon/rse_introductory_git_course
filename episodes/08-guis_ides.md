...
![Example of a complex repository](fig/gui_complex_repo.png "Example of a complex repository")
...
![Sign up for GitKraken with GitHub account](fig/gui_sign_up1.png "Sign up for GitKraken with GitHub account")
...
![Creating a GitKraken profile](fig/gui_sign_up2_create_profile.png "Creating a GitKraken profile")
...
![Opening an existing repository in GitKraken](fig/gui_open_repo1_menu.png "Opening an existing repository in GitKraken")

You should see something like the following:

![Viewing the recipe repository in GitKraken](fig/gui_open_repo2_window.png "Viewing the recipe repository in GitKraken")
...
![Examining file modifications in GitKraken](fig/gui_examine_changed_file.png "Examining file modifications in GitKraken")
...
![Viewing modified files in GitKraken](fig/gui_modifying1.png "Viewing modified files in GitKraken")
...
![Viewing unstaged changes in GitKraken](fig/gui_modifying2_unstaged_changes.png "Viewing unstaged changes in GitKraken")
...
![Committing changes in GitKraken](fig/gui_modifying3_commit_changes.png "Committing changes in GitKraken")
