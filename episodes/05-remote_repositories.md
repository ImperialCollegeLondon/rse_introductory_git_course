...
![Effect of cloning a remote repository](fig/clone.png){alt='Effect of cloning a remote repository'}
...
![Effect of pulling remote changes](fig/pull.png){alt='Effect of pulling remote changes'}
